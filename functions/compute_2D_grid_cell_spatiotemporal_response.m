function responses = compute_2D_grid_cell_spatiotemporal_response(r, RD, ts, grid_cell_2D)
...
%     mod(firing_phase, 360)
    ...
    spatial_response = amplitude * exp( -log(5) * ((r(1)-rc(1)).^2+(r(2)-rc(2)).^2) / R^2 ); % Eq 1 in Neher et al. 2017
